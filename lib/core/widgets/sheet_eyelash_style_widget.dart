...
class BottomSheetEyelashStyle extends StatelessWidget {
  const BottomSheetEyelashStyle({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => AnimatedPositioned(
        ...
        bottom: controller.openStyleEyelashSheet.value ? 10.h : -180.h,
        left: 0,
        right: 0,
        child: GestureDetector(
          ...
          child: Container(
            ...
            child: ListView.builder(
              ...
              itemCount: controller.listEyelash.length,
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ...
                      controller.selectedStyleTool(
                        controller.listEyelash[index]['title'],
                      );
                      controller.isStyleTaped.value =
                          !controller.isStyleTaped.value;
                      
                      controller.EyelashColorMode(controller.listEyelash[index]['title']);
                    ...
                    child: index == 0
                        ? Column(
                            ...
                            children: [
                              SvgPicture.asset(
                                 controller.listEyelash[index]['icon'],
                                width: 28.w,
                                height: 28.h,
                              ),
                              Text(
                        ...
                        : Obx(
                            () => BoxStyleWidget(
                              title: controller.listEyelash[index]['title'],
                              asset: controller.listEyelash[index]['icon'],
                              gradient:
